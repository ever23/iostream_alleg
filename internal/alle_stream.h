...
public:
    ...
    **/
    ...
    /**
    *
    *  si no estas seguro sea llamado en destructor de este
    *  objeto antes de allegro_exit()
    *  deves llamas este metodo antes de llamar a
    *  allegro_exit()
    *  @brief DESTRUYE EL OBJETO
    **/
    void iostream_alleg_exit();
...
//get
    ...
    **/
    ...
    /**
    *  @brief CAMBIA EL BITMAP SEL mouse_sprite
